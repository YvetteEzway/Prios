...
Then Un engagement est créé avec les détails
    ...
    Set Test Variable    ${NUMERO_ENGAGEMENT}    ${valeur1}
...
Then Le détail de l'engagement est affiché avec le code de produit renseigné
    Wait Until Page Contains    Détail engagement ventes [C] - Sté PRIOS - Etablissement CARQUEFOU
...
When L'utilisateur navigue vers l'onglet 'Livraison'
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[9]/div[4]/div[1]/div[1]/div[4]/div/div[2]/span[2]   timeout=5s
...
# Attendre et effectuer plusieurs actions
    ...
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[9]/div[4]/div[1]/div[3]/div[2]/div/button[2]
    Click Element    xpath=/html/body/div[2]/div[1]/div[9]/div[4]/div[1]/div[3]/div[2]/div/button[2]
    Wait Until Element Is visible   xpath=/html/body/div[2]/div[1]/div[10]
...
When L'utilisateur saisit le prix brut unitaire forcé
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[9]/div[4]/div[1]/div[3]/div[3]/div/div[101]/div/input
...
Then Le niveau de prix d'application est sélectionné
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[9]/div[4]/div[1]/div[3]/div[3]/div/div[130]/div[3]/input
...
When L'utilisateur coche la case "Forcé"
     Wait Until Element Is Visible       xpath=/html/body/div[2]/div[1]/div[9]/div[4]/div[1]/div[3]/div[3]/div/div[134]/div/div[2]/input
...
Then L'engagement est affiché dans la liste des engagements en tête
     Wait Until Page Contains    Engagements
...
When L'utilisateur revient à la liste des engagements et effectue une recherche en utilisant la date et le numéro de l'engagement
    ...
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[7]/div[4]/button[1]
    ...
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[7]/div[4]/div[14]/div/input
    Input Text    xpath=/html/body/div[2]/div[1]/div[7]/div[4]/div[14]/div/input    ${NUMERO_ENGAGEMENT}

    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[7]/div[4]/div[8]/div[1]/div/div[1]
...
And l'utilisateur bascule vers l'onglet détails engagement
    Wait Until Element Is Visible   xpath=/html/body/div[2]/div[1]/div[7]/div[4]/div[1]/div[1]/div[4]/div/div[2]/span[2]
...
Then La liste des détails de l'engagement est correctement mise à jour
    Wait Until Page Contains    Détail(s)
    Log  La liste des détails de l'engagement est correctement mise à jour

    Wait Until Element Is Visible         xpath=/html/body/div[2]/div[1]/div[7]/div[4]/div[1]/div[3]/div[2]/div/div[3]/div[2]/div/div[2]/table/tr[1]
