...
When l'utilisateur clique sur le bouton + pour ajouter un produit
    ...
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[9]/div[4]/div[3]/div[1]/div[1]/div[1]/table/tbody/tr[1]/td/img      timeout=30s
...
Then Un formulaire de sélection de produit s'affiche dans une fenêtre pop-up
    ...
    [Documentation]
    Wait Until Page Contains    Détail ordre de livraison [C] - Sté PRIOS - Etablissement CARQUEFOU    timeout=60s
...
When L'utilisateur saisit le Silo dans le champ Silo
    ...
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[10]/div[4]/div[1]/div[3]/div[1]/div/div[76]/div/input       timeout=30s
...
And l'utiloisateur ajoute un autre produit
   Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[10]/div[4]/div[1]/div[3]/div[1]/div/div[3]/div/input     timeout=30s
...
Given l'utilisateur saisit la quantité à livrer2 dans le champ Quantité
    ...
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[10]/div[4]/div[1]/div[3]/div[1]/div/div[25]/div/input   timeout=30s
...
Then Le formulaire d'ajout de produit se ferme et les détails de l'ordre de livraison sont affichés
    Wait Until Page Contains    Détail(s) de l'ordre de livraison       timeout=30s
...
Then Une fenêtre de confirmation affiche les informations suivantes
    ...
    Wait Until Element Is Visible        xpath=/html/body/div[2]/div[1]/div[10]/div[4]/div[33]/div[3]       timeout=30s
    Wait Until Element Is Visible         xpath=/html/body/div[2]/div[1]/div[10]/div[4]/div[33]/div[3]/input    timeout=30s
