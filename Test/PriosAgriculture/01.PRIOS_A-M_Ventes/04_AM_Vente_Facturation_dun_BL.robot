...
When L'utilisateur saisit le numéro du BL dans le champ 'Bon de livraison'
    ...
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[9]/div[4]/div[1]/div[3]/div/div/div[2]/div[1]/table/tr/th[1]        timeout=30s
...
When L'utilisateur fait un clic droit sur le traitement de facture dans la liste créé précédemment, puis clique sur "Simulation"
    ...
    Log     L'utilisateur a fait un clic droit sur le traitement de facture dans la liste.
...
When L'utilisateur clique sur "Validation"
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[7]/div[4]/button[5]     timeout=30s
...
Then Une popup de demande de confirmation du lancement de la validation s'affiche et cliquer sur le bouton "OK"
    Wait Until Element Is Visible  xpath=/html/body/div[2]/div[1]/div[8]/div[2]/div[2]/div/button[1]        timeout=30s
