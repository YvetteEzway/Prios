...
When L'utilisateur sélectionne l'onglet "Tarification"
    Wait Until Element Is Visible    xpath=//span[@class='tabLabel' and text()='Tarifications']     timeout=30s
...
When L'utilisateur saisit un prix sur le champ prix brut unitaire forcé sur "Tarifs appliqués"
    ...
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[10]/div[4]/div[1]/div[3]/div[4]/div/div[38]/div/input       timeout=30s
...
When L'utilisateur sélectionne 'Forçage BL (FBL)' sur la liste déroulante : Motif de forçage du prix
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[10]/div[4]/div[1]/div[3]/div[4]/div/div[44]/div[3]/input        timeout=30s
    Click Element    xpath=/html/body/div[2]/div[1]/div[10]/div[4]/div[1]/div[3]/div[4]/div/div[44]/div[3]/input
    Click Element    xpath=/html/body/div[2]/div[1]/div[10]/div[4]/div[1]/div[3]/div[4]/div/div[44]/div[3]/input

    Wait Until Element Is Visible    xpath=(//input[@value='▼ '])[45]       timeout=250
    Click Element                    xpath=(//input[@value='▼ '])[45]
    Sleep    10s

    # Attendre que la liste déroulante soit visible
    Wait Until Element Is Visible    xpath=//div[@class='dijitPopup dijitComboBoxMenuPopup' and not(contains(@style, 'display: none'))]     timeout=30
