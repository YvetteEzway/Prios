...
When L'utilisateur clique sur "Validation Particulière"
    Wait Until Element Is Visible   xpath=/html/body/div[2]/div[1]/div[9]/div[4]/button[10]     timeout=30s
...
When L'utilisateur coche la case 'Validée et BL généré'
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[10]/div[4]/div[9]/div/div[1]/input      timeout=30s
    Click Element    xpath=/html/body/div[2]/div[1]/div[10]/div[4]/div[9]/div/div[1]/input


And l'utilisateur clique sur "Enregistrer"
    Wait Until Element Is Visible    xpath=/html/body/div[2]/div[1]/div[10]/div[4]/button[6]    timeout=30s
